...
const CartPage = () => {
  ...
  return (
    <>
      <Box bgcolor={Colors.bg} minHeight={"105vh"}>
        <NavigationAuth />
        ...
        >
          ...
          <ul style={{ marginLeft: "20px" }}>
            <li>
              ...
              Make sure to complete your purchase soon so you don’t miss out on
              your favorite finds!
            </li>
            <br />
            <li>
              Once you click the "Buy Now" button, you have
              <strong> 48 hours</strong> to confirm your purchase with the
              seller.
              <br /> If you do not confirm the purchase within this timeframe,
              the item will be automatically removed from your reserved list.
            </li>
          </ul>
        </h5>
