...
const OrderManagement = ({ sellerId }) => {
    ...
    const fetchProducts = async () => {
      try {
        const response = await axios.get(
          `${process.env.REACT_APP_BACKEND}/api/myproducts/orderManage/${sellerId}`,
  ...
  const handleProductStatus = async (productId) => {
    ...
    const endpoint = `${process.env.REACT_APP_BACKEND}/api/myproducts/changeSoldStatus/${productId}`;
